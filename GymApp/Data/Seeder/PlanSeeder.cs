...
public static class PlanSeeder
{
    ...
    {
        using GymDbContext context = new GymDbContext();
        ...
        List<Plan> plans = new()
        {
            ...
            new Plan
            {
                ...
                IsActive = true,
                CreatedAt = new DateTime(2024, 1, 1),
                LastUpdatedAt = new DateTime(2024, 3, 15),
                IsDeleted = false,
                DeletedAt = null
            },
            new Plan
            ...
            new Plan
            {
                ...
                IsActive = true,
                CreatedAt = new DateTime(2024, 1, 1),
                LastUpdatedAt = new DateTime(2024, 4, 10),
                IsDeleted = false,
                DeletedAt = null
            },
            new Plan
            {
                ...
                LastUpdatedAt = new DateTime(2023, 9, 1),
                IsDeleted = true,
